...
static PyObject *impl_keyboard$_winkeyboard$$$function__2__setup_name_tables(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_list_arg_1 = impl___main__$$$function__9_complex_call_helper_star_list(tstate, dir_call_args);
        }
    ...
    }
    {
        ...
        frame_7c06cdd8d1de3cfed4359a6a5a542b00->m_frame.f_lineno = 424;
        {
...
static PyObject *impl_keyboard$_winkeyboard$$$function__9_type_unicode(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
        ...
        {
            PyObject *dir_call_args[] = {tmp_dircall_arg1_1, tmp_dircall_arg2_1};
            tmp_assign_source_17 = impl___main__$$$function__9_complex_call_helper_star_list(tstate, dir_call_args);
        }
        if (tmp_assign_source_17 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
