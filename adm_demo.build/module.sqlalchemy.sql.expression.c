...
static void createModuleCodeObjects(void) {
    ...
    codeobj_91b88ccaedb1ae89a41249e7bad2e798 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE | CO_FUTURE_ANNOTATIONS, mod_consts[298], mod_consts[298], NULL, NULL, 0, 0, 0);
}
...
static function_impl_code const function_table_sqlalchemy$sql$expression[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_sqlalchemy$sql$expression);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_sqlalchemy$sql$expression,
        sizeof(function_table_sqlalchemy$sql$expression) / sizeof(function_impl_code)
    );
}
