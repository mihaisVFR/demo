...
class App(tkm.ThemedTKinterFrame):
    def __init__(self, theme, variant):
        ...
        if variant == "light":
            self.style.configure('TFrame', borderwidth=2, relief='raised' ) # flat, groove, raised, ridge, solid, or sunken
        ...
        self.button1 = self.frame1.Button("1", lambda: self.notebook.notebook.select(1) , col=0, row=2)
        ...
        back = frame2.Button('❮', lambda: ttk.Notebook.select(self.notebook.master, 1), col=4, rowspan=2,  style='x.TButton')
        ...
        back = frame3.Button('❮', lambda: nt[0].select(3), col=6, rowspan=2, style='x.TButton')
        back.configure(width=1)
        ...
        back = self.frame4.Button('❮', lambda: nt[0].select(0), col=7, rowspan=9, style='x.TButton')
        back.configure(width=1)
        ...
        back = self.frame5.Button('❮', lambda: nt[0].select(0), col=9, style='x.TButton', rowspan=5)
        back.configure(width=1)
        # Tab6
        ...
        back = self.frame6.Button('❮', lambda: nt[0].select(0), col=4, rowspan=4, style='x.TButton')
        back.configure(width=1)
        # Tab7
        ...
        back = self.frame7.Button('❮', lambda: nt[0].select(0), col=4, rowspan=4, style='x.TButton')
        back.configure(width=1)
        # Tab8
        ...
        back = frame8.Button('❮', lambda: nt[0].select(0), col=4, style='x.TButton')
        back.configure(width=1)
